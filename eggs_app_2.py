...
st.set_page_config(page_title="エッグスンシングス会計シミュレーター", layout="centered")

st.title("🥞 Eggs 'n Things 会計シミュレーター")
st.caption("公式WEBサイトのメニューを完全網羅（10%税込）")

# 1. 人数選択
party_size = st.number_input("お店に行く人数 (人)", min_value=1, max_value=20, value=2, step=1)

# 2. メニューデータの完全定義（全カテゴリ・全項目）
menu_data = {
    "1. パンケーキ": {
